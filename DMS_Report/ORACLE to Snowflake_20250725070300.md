...
| 5a | P1 | Create Workbench (attempt 1) | {"workBenchName":"ORACLE to Snowflake"} | {"code":"ERR-400","message":"workbench Already exist with same name"} | 400 | FAILED ❌ | 07:03:30 |
...
| 11 | P1 | ANALYZE — Poll attempt 1 | executionId=8667d30d | WORKFLOW_COMPLETED event confirmed in logs | 200 | COMPLETED ✅ | 07:17:00 |
