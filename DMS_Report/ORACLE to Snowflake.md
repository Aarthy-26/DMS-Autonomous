...
| 4 | P1 | Upload File (attempt 1, override=No, domainName=ORACLE to Snowflake) | email=aarthy.jr@ascendion.com, workBenchId=124, file=Silver_Schema_DDL.sql | {"errors":[{"status":500,"code":"ERR-5000","message":"An unexpected error occurred","requestId":"e7f806fc95f28698e74da8f4acb3a1c5"}],"status":"FAILURE"} | 500 | FAILED ❌ | 09:00:30 |
| 5 | P1 | Upload File (attempt 2, override=Yes, domainName=ORACLE to Snowflake) | email=aarthy.jr@ascendion.com, workBenchId=124, file=Silver_Schema_DDL.sql | {"errors":[{"status":500,"code":"ERR-5000","message":"An unexpected error occurred","requestId":"8a70b7d8bedbf7da83979c6205dd054f"}],"status":"FAILURE"} | 500 | FAILED ❌ | 09:00:40 |
...
| 8 | P1 | Upload File (attempt 3, override=No, domainName=Silver_Schema_DDL) | email=aarthy.jr@ascendion.com, workBenchId=124, file=Silver_Schema_DDL.sql | {"errors":[{"status":500,"code":"ERR-5000","message":"An unexpected error occurred","requestId":"55da52bd0069b23301ac2e9520c3c0c2"}],"status":"FAILURE"} | 500 | FAILED ❌ | 09:01:30 |
| 9 | P1 | Fetch Domain File List (poll attempt 2) | {"screen":"analyze","workBenchId":124,"limit":100,"offset":0} | {"data":[],"status":"SUCCESS"} | 200 | COMPLETED ✅ | 09:02:00 |
...
| 8 | P1 | Upload File (attempt 3) | domainName=Silver_Schema_DDL, override=No | {"errors":[{"status":500,"code":"ERR-5000","message":"An unexpected error occurred","requestId":"55da52bd0069b23301ac2e9520c3c0c2"}],"status":"FAILURE"} | 500 | 09:01:30 |

---

*Last updated: 2025-05-22 09:02:00*
