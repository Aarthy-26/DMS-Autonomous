...
| 16 | P1 | ANALYZE — Poll attempt 1 (domainId=386) | Polling status... | IN PROGRESS 🔄 | 07:11:00 |
...
- Step 14: Result fetch testcase=analyze returned HTTP 400 — result confirmed via execution logs (WORKFLOW_COMPLETED)
